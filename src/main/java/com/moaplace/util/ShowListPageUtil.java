...
public class ShowListPageUtil {
	 ...
	 */
	public ShowListPageUtil(int pageNum,int rowBlockCount,int pageBlockCount,int totalRowCount) {
		...
		totalPageCount=
				(int)Math.ceil(totalRowCount/(double)rowBlockCount);
